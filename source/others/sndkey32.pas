(*
  ...
  Changed by José Cláudio Faria: 20/11/2004
...
{ Implements a simple binary search to locate special key name strings }
  ...
  begin
    ...
    if (Result = INVALIDKEY) then
      MessageBox(0, 'Invalid key name!', 'SendKeys Routine',
    ...
    case SendKeysString[I] of
      ...
      '{':
        begin
          ...
          begin
            MessageBox(0, 'No close!', 'SendKeys Routine',
              MB_ICONWARNING or MB_OK);
            Exit;
          end;
          if (SendKeysString[I] = '}') then
      ...
      begin
        ...
        begin
          try
            AttachThreadInput(GetWindowThreadProcessId(GetForegroundWindow,
              nil), GetCurrentThreadId, True);
            PostMessage(GetFocus, WM_IME_CHAR,
              MakeWord(byte(SendKeysString[I + 1]),
              byte(SendKeysString[I])), 0);
            Inc(I);
          finally
            AttachThreadInput(GetWindowThreadProcessId(GetForegroundWindow,
