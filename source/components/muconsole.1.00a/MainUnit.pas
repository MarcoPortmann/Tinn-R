...
begin
  ConsoleIO.SendInput(CommandMemo.Text);
end;

procedure TMainForm.Button2Click(Sender: TObject);
begin
 ConsoleIO.SplitMode := sm0D0A;
end;

procedure TMainForm.Button3Click(Sender: TObject);
begin
 ConsoleIO.SplitMode := smNone;
end;

procedure TMainForm.Button4Click(Sender: TObject);
begin
 ConsoleIO.SplitMode := smSplitchar;
end;
