...
begin
  ...
  begin
    ...
    if (modDados.cdRmirrors.Locate('Country', Text, [loPartialKey]) = True) then
    begin
      Color := clWindow;
      Font.Color := clBlack;
      Font.Style := [];
...
begin
  ...
  begin
    ...
    if (modDados.cdRmirrors.Locate('Name', Text, [loPartialKey]) = True) then
    begin
      Color := clWindow;
      Font.Color := clBlack;
      Font.Style := [];
...
begin
  ...
  begin
    ...
    if (modDados.cdRmirrors.Locate('city', Text, [loPartialKey]) = True) then
    begin
      Color := clWindow;
      Font.Color := clBlack;
      Font.Style := [];
...
procedure TfrmRmirrors.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  with frmTools do
  begin
...
procedure TfrmRmirrors.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
