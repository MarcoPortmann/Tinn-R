...
{$ENDIF}
  ...
  public
    ...
    function Execute(pints1, pints2: PInteger; len1, len2: integer)
      : boolean; overload;
    function Execute(pchrs1, pchrs2: PChar; len1, len2: integer)
      : boolean; overload;
...
begin
  ...
  P8Bits(fDiag) := P8Bits(fDiagBuffer) - sizeof(integer) *
    (MAX_DIAGONAL - MaxOscill);
  P8Bits(bDiag) := P8Bits(bDiagBuffer) - sizeof(integer) *
    (MAX_DIAGONAL - MaxOscill);
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              PCompareRec(fCompareList[j]).oldIndex2 :=
                LastCompareRec.oldIndex2;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              PCompareRec(fCompareList[j]).oldIndex1 :=
                LastCompareRec.oldIndex1;
