...
const
  ...
  aSynMultiSyn: array [0 .. 6] of string = ('HTML complex', 'PHP complex',
    'R complex', 'R doc', 'R html', 'R markdown', 'R noweb');

  sSampleHTMLcomplex: string = '<!-- HTML complex highlighter sample-->'#13#10 +
    '<html>'#13#10 + '  <body>'#13#10 + '    <h1>My First Web Page</h1>'#13#10 +
    '    <p id="demo">My First Paragraph.</p>'#13#10 + '    <script>'#13#10 +
    '      function myFunction()'#13#10 + '      {'#13#10 +
    '      var x="",i=0;'#13#10 + '      for (i=0;i<10;i++)'#13#10 +
    '        {'#13#10 + '        if (i==3)'#13#10 + '          {'#13#10 +
    '          continue;'#13#10 + '          }'#13#10 +
    '        x=x + "The number is " + i + "<br>";'#13#10 + '        }'#13#10 +
    '      document.getElementById("demo").innerHTML=x;'#13#10 + '      }'#13#10
    + '    </script>'#13#10 + '  </body>'#13#10 + '</html>';

  sSamplePHPcomplex: string = '<!-- PHP complex highlighter sample -->'#13#10 +
    '<html>'#13#10 + '  <body>'#13#10 + '    <h1>My First Web Page</h1>'#13#10 +
    '    <p id="demo">My First Paragraph.</p>'#13#10 + '    <script>'#13#10 +
    '      function myFunction()'#13#10 + '      {'#13#10 +
    '      var x="",i=0;'#13#10 + '      for (i=0;i<10;i++)'#13#10 +
    ...
    '        x=x + "The number is " + i + "<br>";'#13#10 + '        }'#13#10 +
    '      document.getElementById("demo").innerHTML=x;'#13#10 + '      }'#13#10
    + '    </script>'#13#10 + '  </body>'#13#10 + '  <?php'#13#10 +
    '  # Comment'#13#10 + '  // Comment'#13#10 + '  /* Comment */'#13#10 +
    ''#13#10 + '  include(''code.php'');'#13#10 +
    '  include ''code.php'';'#13#10 + '  require(''code.php'');'#13#10 +
    '  require_once(''code.php'');'#13#10 + ''#13#10 + '  echo ''abc'';'#13#10 +
    '  print ''abc'';'#13#10 + '  $res = print ''abc'';'#13#10 + ''#13#10 +
    '  $x = 2; # Variables'#13#10 + '  if ($x >= 1 && $x < 3) {'#13#10 +
    '    echo ''Hello Word!'';'#13#10 + '  } else {'#13#10 +
    '    print(''Good by Word!'');'#13#10 + '  }'#13#10 + '  ?>'#13#10 +
    '</html>';

  sSampleRcomplex: string = '# R complex highlighter sample'#13#10 +
    '<<< joseclaudio.faria@gmail.com >>>'#13#10 + '<<< www.uesc.br >>>'#13#10 +
    ''#13#10 + '# Notes and observations!                   # Comment'#13#10 +
    'pB <- 3.5E2                                 # Float number'#13#10 +
    '0 1 2 3 4 5 6 8 9                           # Numbers'#13#10 + #13#10 +
    'variable_a = 1:100                          # Identifier'#13#10 +
    'variable.b <- 1:100                         # Identifier'#13#10 + #13#10 +
    '+ - * / ^ = <- -> <> ~ $ ? ! & :            # Operator'#13#10 +
    '() {} [] ; ,                                # Symbol'#13#10 + #13#10 +
    'NA; NULL; TRUE; T; FALSE; F; if; tryCatch   # Programing'#13#10 + #13#10 +
    'mean(Y); var(Y); sd(Y)                      # Function'#13#10 +
    'xtfrm.numeric_version                       # Function'#13#10 +
    'as.data.frame.model.matrix                  # Function'#13#10 +
    'as.character.numeric_version                # Function'#13#10 + #13#10 +
    'plot(Y ~ X, ylab = ''Y'', xlab = ''X'',         # Plotting'#13#10 +
    '     col = ''blue'', cex = 0.5, pch = ''*'')'#13#10 + #13#10 +
    'airquality; iris; Harman74.cor              # Datasets'#13#10 + #13#10 +
    'cat(''\nI - Basics measures:''); cat(''\n\n'')  # String'#13#10 +
    'string <- "This is" ''a string''              # String'#13#10;

  sSampleRdoc: string = '% R doc highlighter sample'#13#10 +
    '% file MASS/man/caith.Rd'#13#10 +
    '% copyright (C) 1999 W. N. Venables and B. D. Ripley'#13#10 + ''#13#10 +
    '\name{caith}'#13#10 + '\alias{caith}'#13#10 + '\title{'#13#10 +
    '  Colours of Eyes and Hair of People in Caithness'#13#10 + '}'#13#10 +
    '\description{'#13#10 +
    ...
    + '}'#13#10 + '\usage{'#13#10 + 'caith'#13#10 + '}'#13#10 + '\format{'#13#10
    ...
    'par(mfrow=c(1,1))'#13#10 + '}'#13#10 + '\keyword{datasets}';

  sSampleRHtml: string = '<!-- R html highlighter sample -->'#13#10 +
    '<html>'#13#10 + ''#13#10 + '<head>'#13#10 + '<title>Title</title>'#13#10 +
    '</head>'#13#10 + ''#13#10 + '<p>This is an R html document.</p>'#13#10 +
    ''#13#10 + 'You can embed an R code chunk like this:'#13#10 +
    '<!--begin.rcode'#13#10 +
    ...
    'cat(''\nI - Basics measures:''); cat(''\n\n'')  # String'#13#10 +
    'string <- "This is" ''a string''              # String'#13#10 +
    'end.rcode-->'#13#10 + '</body>'#13#10 + '</html>'#13#10;

  sSampleRmarkdown: string = '<!-- R markdown highlighter sample -->'#13#10 +
    'Title'#13#10 + '====='#13#10 + '<!--'#13#10 +
    ' This is a markdown comment!'#13#10 + '-->'#13#10 +
    'This is an R markdown document.'#13#10 + ''#13#10 +
    'You can embed an R code chunk like this:'#13#10 + '```{r}'#13#10 +
    '# Notes and observations!                   # Comment'#13#10 +
    'pB <- 3.5E2                                 # Float number'#13#10 +
    '0 1 2 3 4 5 6 8 9                           # Numbers'#13#10 + #13#10 +
    'variable_a = 1:100                          # Identifier'#13#10 +
  ...
  sSampleRnoweb: string = '% R noweb highlighter sample'#13#10 +
    '\documentclass{article}'#13#10 + '\usepackage{amsmath}'#13#10 +
    '\usepackage{amscd}'#13#10 + '\begin{document}'#13#10 + ''#13#10 +
    '\title{An R noweb demo}'#13#10 +
    '\author{J.C. Faria and P. Grosjean}'#13#10 + '\maketitle'#13#10 + ''#13#10
    ...
    'airquality; iris; Harman74.cor              # Datasets'#13#10 + #13#10 +
    'cat(''\nI - Basics measures:''); cat(''\n\n'')  # String'#13#10 +
    'string <- "This is" ''a string''              # String'#13#10 + '@'#13#10 +
    '\end{document}';

  sSampleST: string = '// Structured Text highlighter sample'#13#10 +
    ...
    '        heater_on:= FALSE;'#13#10 + '    ELSE'#13#10 +
    ...
    '        heater_on:= TRUE;'#13#10 + '    END_IF;'#13#10 +
    '    // ALL IS OK SO CLEAR ALARM FLAG'#13#10 +
    '    tank_alarm:= FALSE;'#13#10 + '  ELSE'#13#10 +
    '    // either the tank is too hot or the set point is above'#13#10 +
    '    // the max allowed temp, warn user'#13#10 +
    '    tank_alarm:= TRUE;'#13#10 + '  END_IF;'#13#10 + 'END_IF;';

  sSampleFortran: string = 'C Fortran highlighter sample'#13#10 +
    ...
    '      INTEGER A,B,C'#13#10 + '   10 READ(5,501,END=50,ERR=90) A,B,C'#13#10
    + '      IF(A=0 .OR. B=0 .OR. C=0) GO TO 90'#13#10 +
    '      S = (A + B + C) / 2.0'#13#10 +
    '      AREA = SQRT( S * (S - A) * (S - B) * (S - C))'#13#10 +
    '      WRITE(6,601) A,B,C,AREA'#13#10 + '      GO TO 10'#13#10 +
    '   50 WRITE(6,602)'#13#10 + '      STOP'#13#10 + '   90 WRITE(6,603)'#13#10
    + '      STOP'#13#10 + '      END';

  sSampleCSS
    : string = '/* Cascading Style Sheets (CSS) highlighter sample */'#13#10 +
    'BODY{ background: white;'#13#10 + '      color: black }'#13#10 + ''#13#10 +
    'A:link{ background: white;'#13#10 + '        color: blue }'#13#10 +
    ''#13#10 + 'A:visited{ background: white;'#13#10 +
    '           color: rgb(50%, 0%, 50%) }'#13#10 + ''#13#10 +
    'H1{ background: white;'#13#10 + '    color: rgb(55%, 55%, 55%);'#13#10 +
    '    font-family: monospace;'#13#10 + '    font-size: x-large;'#13#10 +
    '    text-align: center }'#13#10 + ''#13#10 + 'H2{ background: white;'#13#10
    + '    color: rgb(40%, 40%, 40%);'#13#10 +
    '    font-family: monospace;'#13#10 + '    font-size: large;'#13#10 +
    '    text-align: center }'#13#10 + ''#13#10 + 'H3{ background: white;'#13#10
    + '    color: rgb(40%, 40%, 40%);'#13#10 +
    '    font-family: monospace;'#13#10 + '    font-size: large }'#13#10 +
    ''#13#10 + 'H4{ background: white;'#13#10 +
    '    color: rgb(40%, 40%, 40%);'#13#10 + '    font-family: monospace;'#13#10
    + '    font-style: italic;'#13#10 + '    font-size: large }'#13#10 +
    ''#13#10 + 'IMG.toplogo{ vertical-align: middle }'#13#10 + ''#13#10 +
    'IMG.arrow{ width: 30px;'#13#10 + '           height: 30px;'#13#10 +
    '           border: 0 }'#13#10 + ''#13#10 +
    ...
    'span.pkg{font-weight: bold}'#13#10 + 'span.samp{font-family: monospace}';

  sSampleCSharp: string = '// C# highlighter sample'#13#10 +
    '/* Comment */'#13#10 + 'enum Days {P1, P2, P3};'#13#10 + ''#13#10 +
    'public class Stack: IEdit, IEdit2'#13#10 + '{'#13#10 +
    '  public delegate int[] DelDemo();'#13#10 +
    '  private Node first = null;'#13#10 + '  public bool Empty {'#13#10 +
    '    //property'#13#10 + '    get {'#13#10 +
    '      return (first == null);'#13#10 + '    }'#13#10 + '  }'#13#10 +
    '  public object IEdit.Pop() {'#13#10 + '    if (first == null)'#13#10 +
    '      throw new Exception("Can''t Pop from an empty Stack.");'#13#10 +
    '    else {'#13#10 + '      object temp = first.Value;'#13#10 +
    '      first = first.Next;'#13#10 + '      return temp;'#13#10 +
    '    }'#13#10 + '  }'#13#10 + ''#13#10 +
    '  static void RegisterFunction(Type reg1; Type2 reg2)'#13#10 + '  {'#13#10
    + '    CategoryRegistration(registerType);'#13#10 + '  }'#13#10 + ''#13#10 +
    '  [ComUnregisterFunction()]'#13#10 + '  [ComVisible(false)]'#13#10 +
    '  static void UnregisterFunction(Type reg1; Type[] regs; Type2 reg2)'#13#10
    + '  {'#13#10 + '    CategoryUnregistration(registerType);'#13#10 +
    '  }'#13#10 + '}';

  sSampleUnknowed: string = 'Sorry,'#13#10 +
    'was not possible to find a sample'#13#10 + 'for this highlighter!'#13#10 +
    ''#13#10 + 'Please, see the proper sample in the main editor.';
...
begin
  ...
  synR_term := TSynR_termSyn.Create(Self);
  // Special case used only in Rterm interface!
  ...
  synText_term := TSynText_termSyn.Create(Self);
  // Special case used only in Rterm interface!
  ...
  // PHP complex
  with synPHPcomplex do
  begin
    DefaultLanguageName := 'PHP complex';
    DefaultFilter :=
      'PHP complex (*.php; *.php3; *.phtml; *.inc)|*.php; *.php3; *.phtml; *.inc';
    DefaultHighlighter := synHTML;
    with Schemes do
    begin
      Add.Index := 0;
  ...
  begin
    ...
    DefaultFilter :=
      'R complex (*.R; *.r; *.Rhistory; *.q; *.s; *.ssc)|*.R; *.r; *.Rhistory; *.q; *.s; *.ssc';
  ...
  begin
    ...
    DefaultFilter :=
      'R noweb (*.Rnw; *.rnw; *.Snw; *.snw)|*.Rnw; *.rnw; *.Snw; *.snw';
    DefaultHighlighter := synTeX;
    with Schemes do
    begin
      Add.Index := 0;
...
begin
  ...
  begin
    ...
    else if (sSyntax = 'C/C++') then
      (Components[i] as TSynCustomHighlighter)
        .LoadFromFile(frmTinnMain.sPathSyntax + '\C++.ini')
    else if (sSyntax = 'R term') then
      (Components[i] as TSynCustomHighlighter)
        .LoadFromFile(frmTinnMain.sPathSyntax + '\R.ini')
    else if (sSyntax = 'Text term') then
      (Components[i] as TSynCustomHighlighter)
        .LoadFromFile(frmTinnMain.sPathSyntax + '\Text.ini')
    else
      (Components[i] as TSynCustomHighlighter)
        .LoadFromFile(frmTinnMain.sPathSyntax + '\' + sSyntax + '.ini')
  end;
end;
