...
uses
  ...
  ufrmSearchText, StdCtrls, ExtCtrls;
...
function TfrmReplaceDialog.GetReplaceTextHistory: string;
var
  i: integer;
...
procedure TfrmReplaceDialog.SetReplaceText(sValue: string);
begin
  cbReplaceText.Text := sValue;
end;

procedure TfrmReplaceDialog.SetReplaceTextHistory(sValue: string);
begin
  cbReplaceText.Items.Text := sValue;
end;

procedure TfrmReplaceDialog.FormCloseQuery(Sender: TObject;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        cbReplaceText.Items.Insert(0, sTemp);
