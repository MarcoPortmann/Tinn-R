...
type
  ...
  public
    ...
    procedure PrepareShow(AEditorRect: TRect; iX, iY: integer;
      sReplaceText: string);
  end;
...
begin
  AlphaBlendValue := (frmTinnMain.iAlphaBlendValue * 7) Div 10;
  // I want 30% more transparency!
end;
...
procedure TfrmConfirmReplaceDialog.PrepareShow(AEditorRect: TRect;
  iX, iY: integer; sReplaceText: string);
begin
  lblConfirmation.Caption := Format(rsReplace, [sReplaceText]);

  //SetBounds(AEditorRect.Right - Width - $10, AEditorRect.Top, Width, Height);
end;
